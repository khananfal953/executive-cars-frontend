    ...
    <AuctionLayout title="Won Cars">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          ...
          { label: 'Payment Pending',  value: 0,              color: 'text-red-600',    bg: 'bg-red-50',    border: 'border-red-200'    },
          { label: 'Completed',        value: wonCars.length, color: 'text-green-600',  bg: 'bg-green-50',  border: 'border-green-200'  },
        ].map(s => (
